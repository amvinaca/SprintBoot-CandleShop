...
public class TransactionController {
    ...
    public ModelAndView save(@RequestParam("transactionid") String transactionid,
                             @RequestParam("customern") String customern,
                             @RequestParam("inventoryn") String inventoryn,
                             @RequestParam("employeen") String employeen,
                             @RequestParam("pricen") String pricen,
                               @RequestParam("receiptnum") String receiptnum
                            )
    {
        ...
        companyToSave.setCustomeridfk(customern);
        companyToSave.setInventoryidfk(inventoryn);
        companyToSave.setEmployeeid(employeen);
        companyToSave.setPricen(pricen);
   ...
   @RequestMapping( value = "/delete/{transactionid}", method = RequestMethod.GET) //Delete
    ...
    @RequestMapping( value = "/searchtra") //search bar
